...
from ...models import BusinessTrip, TripDocument
...
def index():
    ...
    view = request.args.get("view", "by_supplier")
...
def new_trip():
    ...
    if request.method == "POST":
        ...
        supplier_code = request.form.get("supplier_code", "").strip() or None
        ...
        if not engineer:
            ...
            return render_template("trip/form.html", mode="new", trip=None,
                                   documents=None,
...
def edit_trip(trip_id):
    ...
    if request.method == "POST":
        ...
        if not engineer or not supplier_name or not purpose:
            ...
            return render_template("trip/form.html", mode="edit", trip=trip,
                                   documents=documents,
                                   doc_types=TRIP_DOC_TYPES,
                                   audit_types=AUDIT_TYPES,
                                   trip_status=TRIP_STATUS)
...
def upload_document(trip_id):
    ...
    # 存储路径：uploads/trip_docs/TRIP_NO/
